...
function getMediaElement(mediaElement, config) {
    ...
    if(config.class == 'main'){
        mediaElementContainer.className = 'media-container main';
    } else {
    ...
    h2.setAttribute('style', 'position: absolute;color: rgb(160, 160, 160);font-size: 14px;text-shadow: 1px 1px rgb(255, 255, 255);padding:0;margin:0;left:5px;top:5px');
